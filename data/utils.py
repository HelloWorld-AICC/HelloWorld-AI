...
# jsonl to metacsv
"""
경기도외국인상담센터 이외의 데이터 처리
"""

def get_external_result_csv(gpt_answer_path:str, meta_path: str, output_path: str, return_type: str, column_name:str) -> list:
    """
    ...
    if return_type == "generate":
        for request in data:
            ...
            result_csv.loc[result_csv["request_id"] == request["custom_id"], "metadata"].values[0]["내담자_추가정보"] = info
